...
public class ExpandedAnimation extends SettingsPreferenceFragment implements Indexable,
        Preference.OnPreferenceChangeListener {

    private static final String TAG = "ExpandedAnimation";

    private static final String PREF_TILE_ANIM_CAT = "tile_animation_settings";
    ...
    private static final int TILE_NO_ANIMATION = 0;
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.expanded_animation);
        ...
        boolean tileAnimationOn = tileAnimationStyle != TILE_NO_ANIMATION;

        PreferenceCategory catTileAnimation =
                (PreferenceCategory) findPreference(PREF_TILE_ANIM_CAT);
        ...
        if (tileAnimationOn) {
            ...
            removePreference(PREF_TILE_ANIM_CAT);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mTileAnimationStyle) {
            ...
            Settings.System.putIntForUser(
                    mResolver, Settings.System.ANIM_TILE_STYLE, intValue,
                    UserHandle.USER_CURRENT);
            ...
            Settings.System.putIntForUser(
                    mResolver, Settings.System.ANIM_TILE_DURATION, intValue,
                    UserHandle.USER_CURRENT);
            ...
            Settings.System.putIntForUser(
                    mResolver, Settings.System.ANIM_TILE_INTERPOLATOR, intValue,
                    UserHandle.USER_CURRENT);
            ...
            intValue = Integer.valueOf((String) newValue);
            index = mTaskManagerAnimation.findIndexOfValue((String) newValue);
            Settings.System.putIntForUser(
                    mResolver, Settings.System.QS_TASK_ANIMATION, intValue,
                    UserHandle.USER_CURRENT);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        ExpandedAnimation getOwner() {
            return (ExpandedAnimation) getTargetFragment();
        }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
            ...
            sir.xmlResId = R.xml.expanded_animation;
            result.add(sir);
